...
encoders=([
    ("encoder", 0,
     Subsignal("A", Pins("j9:1")), #F3
     Subsignal("B", Pins("j9:2")), #F1
     Subsignal("Z", Pins("j9:3")), #G3
     IOStandard("LVCMOS33")),
    ("encoder", 1,
     Subsignal("A", Pins("j9:5")),  # J2.1
     Subsignal("B", Pins("j9:6")),  # J2.2
     Subsignal("Z", Pins("j9:7")),  # J2.3
     IOStandard("LVCMOS33")
     ),
    ("encoder", 2,
     Subsignal("A", Pins("j10:1")),  # J3.1
     Subsignal("B", Pins("j10:2")),  # J3.2
     Subsignal("Z", Pins("j10:3")),  # J3.3
     IOStandard("LVCMOS33")
     ),
    ("encoder", 3,
     Subsignal("A", Pins("j10:5")),  # J4.1
     Subsignal("B", Pins("j10:6")),  # J4.2
     Subsignal("Z", Pins("j10:7")),  # J4.3
     IOStandard("LVCMOS33")
     ),
    ("encoder", 4,
     Subsignal("A", Pins("j11:1")),  # J3.1
     Subsignal("B", Pins("j11:2")),  # J3.2
     Subsignal("Z", Pins("j11:3")),  # J3.3
     IOStandard("LVCMOS33")
     ),
    ("encoder", 5,
     Subsignal("A", Pins("j11:5")),  # J4.1
     Subsignal("B", Pins("j11:6")),  # J4.2
     Subsignal("Z", Pins("j11:7")),  # J4.3
     IOStandard("LVCMOS33")
     )
])
...
stepgens=([
    ("stepgen", 0,
     Subsignal("step", Pins("j1:1")), # J1.1
     Subsignal("dir", Pins("j1:2")), # J1.2
     IOStandard("LVCMOS33")),
    ("stepgen", 1,
     Subsignal("step", Pins("j1:3")),  # J1.3
     Subsignal("dir", Pins("j1:5")),  # J1.5
     IOStandard("LVCMOS33")
     ),
    ("stepgen", 2,
     Subsignal("step", Pins("j1:6")),  # J1.6
     Subsignal("dir", Pins("j1:7")),  # J1.7
     IOStandard("LVCMOS33")
     ),
    ("stepgen", 3,
     Subsignal("step", Pins("j2:1")),  # J2.1
     Subsignal("dir", Pins("j2:2")),  # J2.2
     IOStandard("LVCMOS33")
     ),
    ("stepgen", 4,
     Subsignal("step", Pins("j2:3")),  # J2.3
     Subsignal("dir", Pins("j2:5")),  # J2.5
     IOStandard("LVCMOS33")
     ),
    ("stepgen", 5,
     Subsignal("step", Pins("j2:6")),  # J2.6
     Subsignal("dir", Pins("j2:7")),  # J2.7
     IOStandard("LVCMOS33")
     ),
])
...
#gpios in
_gpios_in = [
    ("gpio_in", 0 , Pins("j13:1"), IOStandard("LVCMOS33")),
    ("gpio_in", 1 , Pins("j13:2"), IOStandard("LVCMOS33")),
    ("gpio_in", 2 , Pins("j13:3"), IOStandard("LVCMOS33")),
    ("gpio_in", 3 , Pins("j13:5"), IOStandard("LVCMOS33")),
    ("gpio_in", 4 , Pins("j13:6"), IOStandard("LVCMOS33")),
    ("gpio_in", 5 , Pins("j13:7"), IOStandard("LVCMOS33")),
    ("gpio_in", 6 , Pins("j14:1"), IOStandard("LVCMOS33")),
    ("gpio_in", 7 , Pins("j14:2"), IOStandard("LVCMOS33")),
    ("gpio_in", 8 , Pins("j14:3"), IOStandard("LVCMOS33")),
    ("gpio_in", 9 , Pins("j14:5"), IOStandard("LVCMOS33")),
    ("gpio_in",10 , Pins("j14:6"), IOStandard("LVCMOS33")),
    ("gpio_in",11 , Pins("j14:7"), IOStandard("LVCMOS33")),
    ("gpio_in",12 , Pins("j15:1"), IOStandard("LVCMOS33")),
    ("gpio_in",13 , Pins("j15:2"), IOStandard("LVCMOS33")),
    ("gpio_in",14 , Pins("j15:3"), IOStandard("LVCMOS33")),
    ("gpio_in",15 , Pins("j15:5"), IOStandard("LVCMOS33")),
    ("gpio_in",16 , Pins("j15:6"), IOStandard("LVCMOS33")),
    ("gpio_in",17 , Pins("j15:7"), IOStandard("LVCMOS33")),
    ("gpio_in",18 , Pins("j16:1"), IOStandard("LVCMOS33")),
    ("gpio_in",19 , Pins("j16:2"), IOStandard("LVCMOS33")),
    ("gpio_in",20 , Pins("j16:3"), IOStandard("LVCMOS33")),
    ("gpio_in",21 , Pins("j16:5"), IOStandard("LVCMOS33")),
    ("gpio_in",22 , Pins("j16:6"), IOStandard("LVCMOS33")),
    ("gpio_in",23 , Pins("j16:7"), IOStandard("LVCMOS33"))
]

#gpios out
_gpios_out = [ \
    ("gpio_out",  0, Pins("j3:1"), IOStandard("LVCMOS33")),
    ("gpio_out",  1, Pins("j3:2"), IOStandard("LVCMOS33")),
    ("gpio_out",  2, Pins("j3:3"), IOStandard("LVCMOS33")),
    ("gpio_out",  3, Pins("j3:5"), IOStandard("LVCMOS33")),
    ("gpio_out",  4, Pins("j3:6"), IOStandard("LVCMOS33")),
    ("gpio_out",  5, Pins("j3:7"), IOStandard("LVCMOS33")),
    ("gpio_out",  6, Pins("j4:1"), IOStandard("LVCMOS33")),
    ("gpio_out",  7, Pins("j4:2"), IOStandard("LVCMOS33")),
    ("gpio_out",  8, Pins("j4:3"), IOStandard("LVCMOS33")),
    ("gpio_out",  9, Pins("j4:5"), IOStandard("LVCMOS33")),
    ("gpio_out", 10, Pins("j4:6"), IOStandard("LVCMOS33")),
    ("gpio_out", 11, Pins("j4:7"), IOStandard("LVCMOS33")),
    ("gpio_out", 12, Pins("j5:1"), IOStandard("LVCMOS33")),
    ("gpio_out", 13, Pins("j5:2"), IOStandard("LVCMOS33")),
    ("gpio_out", 14, Pins("j5:3"), IOStandard("LVCMOS33")),
    ("gpio_out", 15, Pins("j5:5"), IOStandard("LVCMOS33")),
    ("gpio_out", 16, Pins("j5:6"), IOStandard("LVCMOS33")),
    ("gpio_out", 17, Pins("j5:7"), IOStandard("LVCMOS33")),
    ("gpio_out", 18, Pins("j6:1"), IOStandard("LVCMOS33")),
    ("gpio_out", 19, Pins("j6:2"), IOStandard("LVCMOS33")),
    ("gpio_out", 20, Pins("j6:3"), IOStandard("LVCMOS33")),
    ("gpio_out", 21, Pins("j6:5"), IOStandard("LVCMOS33")),
    ("gpio_out", 22, Pins("j6:6"), IOStandard("LVCMOS33")),
    ("gpio_out", 23, Pins("j6:7"), IOStandard("LVCMOS33"))
]

_pwm_out = [ \
    ("pwm_out", 0, Pins("j8:5"), IOStandard("LVCMOS33")),
    ("pwm_out", 1, Pins("j8:6"), IOStandard("LVCMOS33")),
    ("pwm_out", 2, Pins("j8:7"), IOStandard("LVCMOS33")),
]

_ext_reset_in = [("ext_reset_in", 0, Pins("j12:1"), IOStandard("LVCMOS33"))]
#_ext_reset_in = [("ext_reset_in", 0, Pins("j4:6"), IOStandard("LVCMOS33"))]
#_ext_reset_in = [("ext_reset_in", 0, Pins("R7"), IOStandard("LVCMOS33"))]
...
def main():
    ...
    target_group.add_argument("--eth-ip",            default="192.168.0.45", type=str, help="Ethernet/Etherbone IP address.")
    target_group.add_argument("--eth-phy",           default=0, type=int,              help="Ethernet PHY (0 or 1).")
    target_group.add_argument("--mac-address",           default="0x10e2d5000045",              help="Ethernet MAC address in hex format")
    builder_args(parser)
